...
* Who the attackers may be, what businesses were invovled, who the customers are
...
* Risk: function of assests, vulnerabilities and threats (assets * vulnerabilities * threats)
